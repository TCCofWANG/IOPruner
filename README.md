...
Specifically, for both of them, we introduce the concept of block partitioning into structured pruning, \textcolor{red}{collaboratively and flexibly pruning input and output channels. 
